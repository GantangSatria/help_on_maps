...
import 'package:help_on_maps/modules/chat/views/chat_detail_page.dart';
...
import 'package:help_on_maps/modules/splash/views/splash_screen.dart';
import 'package:help_on_maps/routes/app_pages.dart';

class AppRoutes {
  static final routes = [
    GetPage(name: AppPages.onboarding, page: () => SplashScreen()),
    ...
    GetPage(name: AppPages.chatPageDetail, page: () => ChatDetailPage())
  ];
}